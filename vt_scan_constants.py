...
ErrorsStrings = {
    ...
    'fr': {
        ...
        ErrorsCodes.apikey_invalid_char: "Character invalide '{char}' trouvé dans la clé d'API '{apikey}', vous devez la corriger en utilisant le champ apikey de vt_scan_gui ou manuellement dans vt_scan_config.txt",
...
VariousStrings = {
    'en': {
        ...
        VariousCodes.vt_pendings: "VirusTotal scan pending files ({nb}):",
    ...
    'fr': {
        ...
        VariousCodes.file_md5s_nb: "{nb_md5s} MD5s ont été trouvés dans ce fichier.\n",
        VariousCodes.scan_complete: "\nScan complet, ouverture des résultats\n",
        VariousCodes.warning: "\n/!\\ ATTENTION: {message}\n\n",
        VariousCodes.error: "\n/!\\ ERREUR: {message}\n\n",
        ...
        VariousCodes.vt_pendings: "VirusTotal fichiers avec scan en attente ({nb}):",
        VariousCodes.vt_negative: "VirusTotal résultats négatifs ({nb}):",
        VariousCodes.result: "Résultat",
